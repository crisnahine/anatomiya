...
export const RAILS_DIMENSIONS = [
  {
    ...
    applicabilityPredicate: {
      sites: "a migration class defining at least one of change, up or down",
...

  {
    ...
    precision: "partial",
    applicabilityPredicate: {
      sites: "a migration class adding a column, through add_column or a typed t. call inside a create_table or change_table block, and only where its options list can be read",
      blind: "a repository-local base class hides the migration from the superclass test",
    },
    langs: ["ruby"],
    run(ast, add) {
...

  {
    ...
    precision: "partial",
    applicabilityPredicate: {
      sites: "a migration class adding a reference column, through add_reference or add_belongs_to or the matching t. call inside a create_table or change_table block, and only where its options list can be read",
      blind: "a repository-local base class hides the migration from the superclass test",
    },
    langs: ["ruby"],
    run(ast, add) {
