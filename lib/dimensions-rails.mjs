...
export const RAILS_DIMENSIONS = [
...

  {
    ...
    precision: "partial",
    applicability: {
      sites: "a migration class whose body reaches a model or issues raw SQL",
...

  {
    ...
    precision: "partial",
    applicability: {
      sites: "a migration class adding a reference column, through add_reference or inside a create_table or change_table block",
      blind: "a repository-local base class hides the migration from the superclass test",
    },
    langs: ["ruby"],
    run(ast, add) {
