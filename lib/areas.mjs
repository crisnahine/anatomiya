...
// Every extension `isSource` admits for that language, or the glob delivers to
// less than the counts were taken over. Listing one the repository does not use
// matches nothing extra, so the list is the language's, not the area's.
const EXT_BY_LANG = {
