...
import { resolveBaseline, baselinePopulation, baselineStates, materialize, changedSinceWorktree, loadPin } from "./baseline.mjs";
...
export async function scan(cwd, { onProgress = () => {}, baseRef = null, rubyGuards = null } = {}) {
  ...
  return {
    ...
    corpus: { files: files.length, untracked, truncated, dropped },
