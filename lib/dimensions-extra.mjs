...
export const EXTRA_DIMENSIONS = [
...

  {
    ...
    // stripped to whitespace can only answer it wrongly. `parse-worker.mjs`
    // drops this row for such a file rather than counting a confident zero.
    readsTypeSyntax: true,
    langs: ["js", "jsx"],
    run(program, add) {
      walk(program, (n) => {
