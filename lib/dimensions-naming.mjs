 ...
 * a site counted inside it would move once the retry ran. A default export
 * binds no name to check. A specifier (`export { foo as bar }`) renames a
...
export const NAMING_AST = [
  ...
  },
  {
    ...
    precision: "precise",
    applicabilityPredicate: {
      sites: "an export statement declaring a function, or a variable not bound to a class expression, under a name that spells a naming class; a default export carries no name, and a renaming specifier is not resolved to a declaration, so neither is a site",
      blind: null,
    },
    langs: ["js", "jsx"],
    run(program, add) {
  ...
  },
  {
    ...
    precision: "precise",
    applicabilityPredicate: {
      sites: "an export statement declaring a class, or a variable bound to a class expression, under a name that spells a naming class; a default export carries no name, and a renaming specifier is not resolved to a declaration, so neither is a site",
      blind: null,
    },
    langs: ["js", "jsx"],
    run(program, add) {
  ...
  },
  {
    ...
    precision: "precise",
    applicabilityPredicate: {
      sites: "an export statement declaring an interface, a type alias, or an enum, under a name that spells a naming class; a default export carries no name, and a renaming specifier is not resolved to a declaration, so neither is a site",
      blind: null,
    },
    langs: ["js", "jsx"],
    run(program, add) {
