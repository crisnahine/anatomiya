...
export const RUBY_DIMENSIONS = [
...

  {
    ...
    precision: "partial",
    applicabilityPredicate: {
      sites: "a Ruby file declaring a class or module with a call, perform, execute or run method, on the instance or on self. Without that narrowing this would count every raise in the repository and measure nothing",
