...
export const RUBY_DIMENSIONS = [
...

  {
    ...
    precision: "partial",
    applicabilityPredicate: {
      sites: "a Ruby file calling find or find_by on a constant receiver, with no block",
...

  {
    ...
    precision: "precise",
    applicabilityPredicate: {
      sites: "a Ruby file declaring a method taking three or more parameters, positional and keyword together",
      blind: null,
    },
    langs: ["ruby"],
    run(ast, add) {
