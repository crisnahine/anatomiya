...
export const CAPABILITY_DIMENSIONS = [
  {
    ...
    applicabilityPredicate: {
      ...
      blind: "a logging call behind a helper with another name, a re-export, or the wrapper's own console call is not seen",
    },
    langs: ["js", "jsx"],
    run(program, add) {
...

  {
    ...
    precision: "partial",
    applicabilityPredicate: {
      sites: "a file reading a property off process.env, or off a binding imported from a relative module whose filename says config, env or settings",
