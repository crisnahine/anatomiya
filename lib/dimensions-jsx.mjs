...
export const JSX_DIMENSIONS = [
  {
    ...
    applicabilityPredicate: {
      sites: "a JSX file calling one of React's own hooks by name, either bare or through the React namespace. A hook this repository wrote carries no name this can know",
      blind: null,
    },
    langs: ["jsx"],
