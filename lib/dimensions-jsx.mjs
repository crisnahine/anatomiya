...
export const JSX_DIMENSIONS = [
  {
    ...
    precision: "precise",
    langs: ["jsx"],
    // Applicable: files calling a React hook in either form. Candidates: those
    // calls. The reported node is the callee, never the CallExpression:
...

  {
    ...
    counterClaim: null,
    precision: "partial", // a string handed to a component through a prop is invisible here
    langs: ["jsx"],
    /**
...

  {
    ...
    precision: "partial", // a handler defined in another file, or bound by destructuring, is invisible
    langs: ["jsx"],
    /**
