...
import { kindsLine, layoutSummary, plural, renderLayout, ROOT_LABEL } from "./render-layout.mjs";
...
// The layout section prints from its own module, and the four names other
// files already take from here keep answering to this one.
export { layoutSummary, plural, renderLayout, ROOT_LABEL };
