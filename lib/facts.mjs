...
// record, so the older joined form needs no rule here. A version this reader has
// not heard of is refused.
export const FACTS_SCHEMA = 4;
...
export function writeFacts(root, result) {
  ...
  atomic(path, JSON.stringify(factsRecord(result), null, 2) + "\n");
}
