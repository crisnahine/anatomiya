...
export function planMap(result) {
  ...
  // Thrown before the bodies below, because 151 area bodies rendered to be
  // discarded is work a repository should not be able to ask for.
...
export function commitMap(root, plan) {
  ...
  if (!plan.blind) writeFacts(root, plan.result);
