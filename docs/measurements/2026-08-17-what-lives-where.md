...
Re-run again after the mixin fix and the CommonJS one: 35 of 35, and the only column that moved is
...
Re-run again after the votable-candidate fix: 35 of 35, no counted number in the table moved, the
five learned tables are byte-identical again, and one repository moved an `under` clause back
(change 11 below).

Re-run again after the one-match floor and the code-unit ties, which is the run recorded here: 35 of
35, no counted number in the table moved and the five learned tables are byte-identical again. 14 of
the 35 sections moved: 17 clauses on 11 repositories dropped an `under` (change 15 below), and five
lines on four repositories name a different third extension or sibling-module stem, because the
sorts that pick those names now break a tie on code units rather than on `localeCompare` (change 16
below).
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Homebrew__brew | 2501 | 3 | 0 | 3 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14.5 |
| TryGhost__Ghost | 7940 | 5 | 0 | 6 | 2 | 1 | 0 | 0 | 0 | 0 | 142 | 87 | 14.5 |
| alphagov__whitehall | 2621 | 7 | 8 | 3 | 1 | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 8.1 |
| angular__angular | 8522 | 7 | 11 | 3 | 2 | 0 | 0 | 0 | 0 | 0 | 93 | 103 | 14.1 |
| appsmithorg__appsmith | 13087 | 3 | 0 | 5 | 2 | 0 | 0 | 0 | 0 | 0 | 126 | 128 | 15.3 |
| babel__babel | 2303 | 7 | 10 | 3 | 1 | 0 | 0 | 0 | 0 | 0 | 26 | 16 | 5.6 |
| backstage__backstage | 11781 | 7 | 5 | 2 | 2 | 0 | 0 | 0 | 0 | 0 | 186 | 99 | 15.2 |
| calcom__cal.diy | 7372 | 7 | 4 | 4 | 2 | 0 | 0 | 0 | 0 | 0 | 122 | 60 | 9.4 |
| chef__chef | 2281 | 7 | 1 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 11.4 |
| consul__consul | 6025 | 7 | 2 | 1 | 1 | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 7.4 |
| decidim__decidim | 11467 | 7 | 18 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 4 | 5 | 21.3 |
| diaspora__diaspora | 1921 | 7 | 5 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 5.1 |
| discourse__discourse | 23263 | 7 | 5 | 6 | 1 | 1 | 3 | 2 | 0 | 0 | 75 | 12 | 64.4 |
| empire-flippers__api | 8986 | 7 | 2 | 2 | 1 | 0 | 7 | 3 | 0 | 0 | 0 | 0 | 18.7 |
| empire-flippers__client | 2999 | 7 | 3 | 2 | 2 | 0 | 0 | 0 | 6 | 0 | 86 | 44 | 5.1 |
...
| forem__forem | 6425 | 7 | 6 | 3 | 2 | 0 | 1 | 1 | 0 | 0 | 14 | 7 | 14.7 |
| huginn__huginn | 729 | 7 | 9 | 1 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 2.7 |
| instructure__canvas-lms | 21913 | 7 | 8 | 4 | 2 | 0 | 1 | 0 | 0 | 0 | 148 | 129 | 101.7 |
| mastodon__mastodon | 9846 | 7 | 5 | 3 | 2 | 0 | 1 | 0 | 0 | 0 | 20 | 23 | 11.2 |
| microsoft__vscode | 15712 | 4 | 0 | 6 | 2 | 0 | 0 | 0 | 14 | 0 | 164 | 90 | 54.9 |
| openfoodfoundation__openfoodnetwork | 3882 | 7 | 7 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 3 | 1 | 10.1 |
| opf__openproject | 22498 | 7 | 8 | 3 | 1 | 0 | 1 | 0 | 0 | 0 | 22 | 7 | 47.7 |
| prisma__prisma | 6154 | 7 | 7 | 3 | 2 | 0 | 0 | 0 | 0 | 0 | 115 | 76 | 9.1 |
| publiclab__plots2 | 860 | 7 | 6 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 1 | 0 | 2.5 |
| puppetlabs__puppet | 2466 | 7 | 0 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 15.9 |
| react__react | 2969 | 7 | 18 | 3 | 2 | 1 | 0 | 0 | 0 | 0 | 16 | 34 | 8.9 |
| rubocop__rubocop | 2155 | 7 | 2 | 2 | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 8.6 |
| storybookjs__storybook | 7597 | 5 | 0 | 7 | 2 | 0 | 0 | 0 | 0 | 0 | 75 | 77 | 12.0 |
| supabase__supabase | 16751 | 4 | 0 | 4 | 2 | 0 | 0 | 0 | 0 | 0 | 198 | 157 | 14.7 |
| typeorm__typeorm | 3542 | 7 | 0 | 3 | 2 | 1 | 0 | 0 | 0 | 0 | 8 | 25 | 4.4 |
| vercel__next.js | 28490 | 7 | 2 | 5 | 2 | 1 | 0 | 0 | 0 | 0 | 28 | 58 | 28.9 |
...
of the second, two against the clauses the list below this one named as reading wrong, two that
this document's own audit section asked for, and two more out of the last review round: the worst
reading that list still carried, and the tie-break under every name the section prints.
...
### 15. A namesake clause resting on one answered file names no root

Was: any root whose namesake votes agreed named the directory they agreed on. Now that, above one
answered source file: a root with a single answered file behind it keeps its counts and prints
without `under`.

Change 11's half rule refuses a root most of the matches disagree with, and one match cannot
disagree with itself, so the name was whatever that one file's test happened to sit in. This is the
reading the list below named as the worst of them: react's `packages/react` answers one file,
`packages/react/index.js`, which voted for a compiled fixture bundle. The line read `1 of 51 has a
namesake test under packages/react-devtools-shared/src/hooks/__tests__/__source__/__compiled__/bundle`
and now reads `1 of 51 has a namesake test`.

17 clauses on 11 repositories dropped their `under` and kept every count:

| repository | root | clause | the directory it had named |
|---|---|---|---|
| babel | `packages/babel-types` | 1 of 95 | `packages/babel-types/test` |
| babel | `packages/babel-traverse` | 1 of 35 | `packages/babel-traverse/test` |
| babel | `eslint` | 1 of 34 | `eslint/babel-eslint-parser/test` |
| empire-flippers/client | `src/components` | 1 of 504 | `cypress/integration/components` |
| eslint | `lib/languages/js` | 1 of 17 | `tests/lib/languages/js` |
| huginn | `config` | 1 of 35 | `spec` |
| mastodon | `app/javascript` | 1 of 429 | `app/javascript/mastodon/components/__tests__` |
| prisma | `examples` | 1 of 265 | `examples/retail-store/test` |
| plots2 | `config` | 1 of 37 | `test/integration` |
| react | `scripts` | 1 of 148 | `scripts/error-codes/__tests__` |
| react | `packages/react-devtools-shared/src/devtools/views` | 1 of 149 | `packages/react-devtools-inline/__tests__/__e2e__` |
| react | `packages/react` | 1 of 51 | `packages/react-devtools-shared/src/hooks/__tests__/__source__/__compiled__/bundle` |
| react | `packages/react-reconciler/src (files at this level)` | 1 of 82 | `packages/react-reconciler/src/forks` |
| storybook | `agent-eval` | 1 of 36 | `agent-eval` |
| typeorm | `src/error` | 1 of 61 | `test/functional/database-schema/custom-constraint-names/index` |
| typeorm | `src/query-builder` | 1 of 39 | `test/functional/database-schema/custom-constraint-names/index` |
| webpack | `examples` | 1 of 453 | `test` |

Nothing else moved with it. The tests line passes `root: null` for its own namesake clause and never
named a directory for one match, and no counted number in the table changed.

### 16. The ties under a printed name break on code units

Was: `localeCompare` under the root order, the tests line, the extension and stem tallies, the
runner groups and both sibling rosters. Now the code-unit compare the namesake vote already uses.
ICU orders case by whatever tables the host was built with, so two names at the same count could
swap between machines, and each of these sorts decides what the section prints.

Five lines on four repositories name a different extension or stem, all of them a tie:

| repository | line | was | now |
|---|---|---|---|
| cal.diy | `packages/lib (files at this level)` | `array/availability/buildCalEventFromBooking` | `CalEventParser/CalendarAppError/CalendarService` |
| cal.diy | `packages/ui/components` | `index/types/dateRangeLogic` | `index/types/ExampleTheme` |
| supabase | `packages/ui` | `index/assets.d/clipboard` | `index/CustomHTMLElements.utils/assets.d` |
| forem | `app/models` | `166 .rb, 1 .md` | `166 .rb, 1 (none)` |
| react | `scripts` | `161 .js, 6 .md` | `161 .js, 6 (none)` |

A name can only swap with one at its own count, because the count compare comes first and no change
here touched it: the third stem on cal.diy's `packages/ui/components`, all three on its
`packages/lib` line, where every file at that level has a stem of its own, the second and third on
supabase's `packages/ui`, and the second extension on two lines holding as many extensionless files
as markdown ones, 1 on forem and 6 on react. `(` sorts before `.`, which is what puts `(none)`
first. The order was arbitrary either way and is now the same order on every machine.

The four sorts that predate this branch keep `localeCompare`: they order area paths and finding
lines, which is a different question from what a count prints.
...
react's `packages/react` named a compiled fixture bundle under `__source__/__compiled__`. Change 15
suppresses the name at one answered file and keeps the counts, so all 17 of those clauses print
bare. What is left to read is the count itself: `1 of 429` says one file in that root has a namesake
and nothing about where the rest of them would go.
...
- packages/babel-types: 95 .ts, 20 .js and 4 other; 20 test files; 1 of 95 has a namesake test
...
- eslint: 34 .ts, 21 .js and 18 other; 10 test files; 1 of 34 has a namesake test
- packages/babel-traverse: 36 .ts, 19 .js and 4 other; 18 test files under test; 1 of 35 has a namesake test
...
- packages/ui/components: 140 .tsx (JSX), 63 .ts and 14 other; 26 vitest specs; 8 test files; 9 of 108 have a namesake test under packages/ui/components; 62 sibling modules named index/types/ExampleTheme; 24 files inline a helper
- packages/lib (files at this level): 146 .ts, 4 .json and 4 other; 22 vitest specs; 21 of 124 have a namesake test under packages/lib; 124 sibling modules named CalEventParser/CalendarAppError/CalendarService; 1 file inlines a helper
...
- lib/languages/js: 17 .js; 1 of 17 has a namesake test
...
- app/controllers: 264 .rb, 1 (none); 14 of 264 have a namesake test under spec/controllers
- app/models: 166 .rb, 1 (none) and 1 other; 134 of 166 have a namesake test under spec/models
...
- config: 35 .rb, 4 .yml; 1 of 35 has a namesake test
...
- app/javascript: 432 .tsx (JSX), 341 .svg and 775 other; 24 test files; 2 vitest specs; 1 of 429 has a namesake test; 325 sibling modules named index/accounts/notifications; 177 files inline a helper
...
- examples: 311 .ts, 95 .json and 133 other; 46 vitest specs under test; 1 test file under test; 1 of 265 has a namesake test; 268 sibling modules named contract.d/prisma.config/db; 7 files inline a helper
...
- config: 37 .rb, 22 .yml and 11 other; 1 of 37 has a namesake test
...
- scripts: 161 .js, 6 (none) and 29 other; 13 test files under __tests__; 1 of 148 has a namesake test; 149 sibling modules named build/benchmark/index; 0 files inline a helper
- packages/react-devtools-shared/src/devtools/views: 149 .js (JSX), 80 .css; 1 of 149 has a namesake test; 27 sibling modules named utils/constants/types; 43 files inline a helper
...
- packages/react: 76 .js, 6 .ts and 3 other; 31 test files under __tests__; 1 of 51 has a namesake test; 51 sibling modules named compiler-runtime/index/jsx-dev-runtime; 2 files inline a helper
- packages/react-reconciler/src (files at this level): 82 .js; 1 of 82 has a namesake test
...
- agent-eval: 89 .ts, 78 .tsx and 138 other; 53 vitest specs; 1 of 36 has a namesake test; 48 sibling modules named main/vitest.config/preview; 0 files inline a helper
...
- packages/ui: 129 .tsx (JSX), 18 .svg and 27 other; 7 vitest specs; 5 of 123 have a namesake test under packages/ui; 16 sibling modules named index/CustomHTMLElements.utils/assets.d; 13 files inline a helper
...
- src/error: 61 .ts; 1 of 61 has a namesake test
- src/query-builder: 39 .ts; 1 of 39 has a namesake test
...
- examples: 453 .js, 181 .md and 118 other; 1 of 453 has a namesake test; 450 sibling modules named build/webpack.config/example; 0 files inline a helper
