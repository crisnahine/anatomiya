...
A dimension is one claim about one area. 46 ship, the filename row included: 25 for JavaScript, 30 reachable in JSX, and 15 that speak Ruby, plus the one type-checked row, which sits in the total and reaches a scan only with --deep. Each
